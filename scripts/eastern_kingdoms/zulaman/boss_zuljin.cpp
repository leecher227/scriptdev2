...
#define CENTER_X            120.15f
#define CENTER_Y            703.71f
#define CENTER_Z            45.11f
...
struct MANGOS_DLL_DECL boss_zuljinAI : public ScriptedAI
{
    ...
    void EnterPhase(uint32 NextPhase)
    {
        ...
        case 4:
            ...
            m_creature->SendMonsterMove(CENTER_X, CENTER_Y, CENTER_Z, SPLINETYPE_NORMAL, SPLINEFLAG_WALKMODE, 0);
            DoResetThreat();
